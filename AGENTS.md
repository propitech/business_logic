...
<!-- Baseline: agents-baseline-v2.0.0 (source: agents-baseline-v2.0.0)                  -->
...
- **Notion is the source of truth for the product and the durable decisions**; a
  shipped feature gets a domain page under Product & Features.
...
- **A material decision is recorded when it is made, not remembered** — write a
  settled or reversed call to the plan's Resolved decisions and the relevant
  Notion page, capturing *why*. (`agentic-workflow:document-decision`)
